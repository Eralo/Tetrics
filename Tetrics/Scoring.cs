...
namespace Tetrics {
    public class Scoring {
        ...
        private readonly int[] speed = new int[] { //speed per level: obtained by number of frames divided by 60 (frames sec). Stays at 30 for 19-28 and 16 above
            ...
            800, 717, 1579, 1818, 633, 550, 466, 383, 300, 216, 133, 100, 83, 83, 83, 66, 66, 66, 50, 50, 50, 30, 16
        };
        ...
        public void AddScore(int lines, int combo) {
            switch (lines) {
                ...
                case 4: if (BacktoBack) Score += 800 * Level * ((800 * Level) / 2); else Score += 800 * Level; BacktoBack = true; break;   //I don't want to use float to do *1.5 so use of approximation
                case 0:
                default:
                    return;
            }
        ...
        public int CurrentSpeed() {
            ...
            if (Level >= 29) return speed[22];
            else return speed[21];
